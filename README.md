...
From ~3 MB (Silero VAD) to ~6.5 GB (PersonaPlex 7B). Kokoro TTS uses ~200 MB (1 bucket), Qwen3-ASR ~2.2 GB. See the [Memory Requirements](#memory-requirements) table for full details.
